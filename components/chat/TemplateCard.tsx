...
import { ExternalLink, Star, Download, User } from 'lucide-react'
...
export function TemplateCard({
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative flex flex-col gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-blue-500 dark:hover:border-blue-400 hover:shadow-md transition-all cursor-pointer"
    >
      {/* Header */}
