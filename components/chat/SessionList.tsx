        ...
        <div className="px-2 pt-2 pb-1 flex items-center gap-1.5">
          {isSelecting ? (
            <>
              <button
                onClick={selectAll}
                className="flex items-center gap-1 text-[10px] font-semibold text-[#4f46e5] hover:text-[#4338ca] transition-colors"
              >
                {allSelected ? (
              ...
              <button
                ...
                className="ml-auto p-1 text-[#6b7280] hover:text-[#191c1e] rounded transition-colors"
            ...
            <button
              onClick={toggleSelectMode}
              className="ml-auto flex items-center gap-1 text-[10px] font-semibold text-[#6b7280] hover:text-[#4f46e5] transition-colors"
            >
              <CheckSquare className="w-3.5 h-3.5" />
              Select
            </button>
